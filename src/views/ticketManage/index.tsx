...
import { Breadcrumb, Button, Card, Col, DatePicker, Divider, Form, Input, InputNumber, Layout, Modal, Row, Select, Space, Table, message } from 'antd';
      ...
      <Layout style={{ borderRadius: '10', backgroundColor: 'white', overflow: 'auto', height: '70vh' }}>
        <Content style={{ padding: '0 50px', borderRadius: '10' }}>
              ...
              <Row gutter={16}>
                <Col span={12}>
                  ...
                  >
                    <InputNumber
                      style={{ width: '10vw' }}
                      placeholder="请输入票价" prefix={<UserOutlined rev={undefined} />} />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <Form.Item
                  ...
                  >
                    <InputNumber
                      style={{ width: '10vw' }}
                      placeholder="请输入票数" prefix={<UserOutlined rev={undefined} />} />
                  </Form.Item>
                </Col>
              </Row>
              <Form.Item
          ...
          <Modal
            ...
            open={myInfoVisible}
            // onOk={handleOkDeleteUser}
            onCancel={() => { setMyInfoVisible(false) }}
            footer={false}
          >
            <Card title="购票信息">
              {userInfo && userInfo.length > 0 ? (
                ...
                <Card.Grid style={gridStyle}>No ticket information available.</Card.Grid>
              )}
            </Card>
          </Modal>
        </Content>
